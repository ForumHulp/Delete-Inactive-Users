...
$lang = array_merge($lang, array(
	...
	'LOG_INACTIVE_USERS'		=> '<strong>Usuarios inactivos borrados</strong><br />» %s',
	'INACTIVE_USERS_NOTICE'		=> '<div class="phpinfo"><p class="entry">Ajustes de configuración en %1$s » %2$s » %3$s.</p></div>'
));
